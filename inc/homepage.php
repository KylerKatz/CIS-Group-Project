  ...
  <span>
    <span id="welcome-text-block">
      <p id="left-text"> Hello and welcome to the Open University Learning Trends website!
        The purpose of this website is to offer teachers and faculty insight into how metrics such as gender, socio-economic status, and course interactions can affect student learning outcomes.
