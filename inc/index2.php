...
if ($_POST['sem'] == 'all') {
  ...
  (SELECT COUNT(id_Student) AS s FROM kkatz.studentinfo WHERE imd_band = '0-10%' AND final_result = 'Pass' )p1,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '0-10%' AND final_result = 'Withdrawn')w1,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '0-10%' AND final_result = 'Distinction')d1,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '0-10%' AND final_result = 'Fail')f1,
   
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '10-20')T2,
  (SELECT COUNT(id_Student) AS s FROM kkatz.studentinfo WHERE imd_band = '10-20' AND final_result = 'Pass'  )p2,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '10-20' AND final_result = 'Withdrawn'  )w2,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '10-20' AND final_result = 'Distinction')d2,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '10-20' AND final_result = 'Fail' )f2,
  
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '20-30%')T3,
  (SELECT COUNT(id_Student) AS s FROM kkatz.studentinfo WHERE imd_band = '20-30%' AND final_result = 'Pass' )p3,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '20-30%' AND final_result = 'Withdrawn')w3,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '20-30%' AND final_result = 'Distinction')d3,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '20-30%' AND final_result = 'Fail' )f3,
  
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '30-40%')T4,
  (SELECT COUNT(id_Student) AS s FROM kkatz.studentinfo WHERE imd_band = '30-40%' AND final_result = 'Pass' )p4,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '30-40%' AND final_result = 'Withdrawn' )w4,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '30-40%' AND final_result = 'Distinction' )d4,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '30-40%' AND final_result = 'Fail' )f4,
  
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '40-50%')T5,
  (SELECT COUNT(id_Student) AS s FROM kkatz.studentinfo WHERE imd_band = '40-50%' AND final_result = 'Pass' )p5,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '40-50%' AND final_result = 'Withdrawn'  )w5,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '40-50%' AND final_result = 'Distinction')d5,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '40-50%' AND final_result = 'Fail' )f5,
  
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '50-60%')T6,
  (SELECT COUNT(id_Student) AS s FROM kkatz.studentinfo WHERE imd_band = '50-60%' AND final_result = 'Pass')p6,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '50-60%' AND final_result = 'Withdrawn')w6,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '50-60%' AND final_result = 'Distinction')d6,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '50-60%' AND final_result = 'Fail' )f6,
  
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '60-70%')T7,
  (SELECT COUNT(id_Student) AS s FROM kkatz.studentinfo WHERE imd_band = '60-70%' AND final_result = 'Pass')p7,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '60-70%' AND final_result = 'Withdrawn')w7,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '60-70%' AND final_result = 'Distinction' )d7,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '60-70%' AND final_result = 'Fail' )f7,
  
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '70-80%')T8,
  (SELECT COUNT(id_Student) AS s FROM kkatz.studentinfo WHERE imd_band = '70-80%' AND final_result = 'Pass')p8,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '70-80%' AND final_result = 'Withdrawn' )w8,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '70-80%' AND final_result = 'Distinction' )d8,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '70-80%' AND final_result = 'Fail' )f8,
  
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '80-90%')T9,
  (SELECT COUNT(id_Student) AS s FROM kkatz.studentinfo WHERE imd_band = '80-90%' AND final_result = 'Pass' )p9,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '80-90%' AND final_result = 'Withdrawn')w9,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '80-90%' AND final_result = 'Distinction')d9,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '80-90%' AND final_result = 'Fail' )f9,
  
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '90-100%')T10,
  (SELECT COUNT(id_Student) AS s FROM kkatz.studentinfo WHERE imd_band = '90-100%' AND final_result = 'Pass' )p10,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '90-100%' AND final_result = 'Withdrawn')w10,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '90-100%' AND final_result = 'Distinction')d10,
  (SELECT COUNT(id_student) AS s FROM kkatz.studentinfo  WHERE imd_band = '90-100%' AND final_result = 'Fail' )f10");
  ...
  FROM
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '0-10%' AND code_presentation = '$sem')T1,
  ...
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '10-20' AND code_presentation = '$sem')T2,
  ...
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '20-30%' AND code_presentation = '$sem')T3,
  ...
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '30-40%' AND code_presentation = '$sem')T4,
  ...
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '40-50%' AND code_presentation = '$sem')T5,
  ...
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '50-60%' AND code_presentation = '$sem')T6,
  ...
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '60-70%' AND code_presentation = '$sem')T7,
  ...
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '70-80%' AND code_presentation = '$sem')T8,
  ...
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '80-90%' AND code_presentation = '$sem')T9,
  ...
  (SELECT COUNT(id_Student) AS Total FROM kkatz.studentinfo  WHERE imd_band = '90-100%' AND code_presentation = '$sem')T10,
